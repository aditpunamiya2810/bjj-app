...
if st.button("🚀 START ANALYSIS"):
    ...
    def run_backend():
        try:
            result_container['data'] = analyze_video_with_gemini(
                tmp_video_path, user_desc, opp_desc, API_KEY,
    ...
    st.markdown("### ⏱️ INTERVAL BREAKDOWN")
    ...
    with dl_col1:
        ...
        st.download_button("📊 Download Interval CSV", data=csv_data, file_name="bjj_intervals.csv", mime="text/csv", use_container_width=True)
    with dl_col2:
